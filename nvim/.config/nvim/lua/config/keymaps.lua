...
-- Terminal
vim.keymap.set("n", "<leader>ot", "<cmd>ToggleTerm<cr>", { desc = "Toggle bottom terminal" })
vim.keymap.set("n", "<leader>of", "<cmd>ToggleTerm direction=float<cr>", { desc = "Toggle floating terminal" })
vim.keymap.set("n", "<leader>ov", "<cmd>ToggleTerm direction=vertical size=60<cr>", { desc = "Toggle vertical terminal" })
vim.keymap.set("n", "<leader>oh", "<cmd>ToggleTerm direction=horizontal size=20<cr>", { desc = "Toggle horizontal terminal" })
